    ...
    return new Promise((resolve, reject) => {
      pool.getConnection((err, connection) => {
        ...
        connection.query('SELECT * FROM `tasks`', (err, rows) => {
          ...
          // до ресолва (так как после него выполнение промиса прерывается) необходимо вернуть соединение обратно в pool. Если не будем возвращать,
          ...
          resolve(rows);
          //resolve ({...rows[0]}) - для однострочных позиций
        })
      })
    })
  }
